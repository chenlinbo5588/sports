...
0
|| checktplrefresh('./template/default/home/space_pm.htm', './template/default/common/simplesearchform.htm', 1348885293, 'diy', './data/template/1_diy_home_space_pm.tpl.php', './template/default', 'home/space_pm')
|| checktplrefresh('./template/default/home/space_pm.htm', './template/default/home/space_pm_node.htm', 1348885293, 'diy', './data/template/1_diy_home_space_pm.tpl.php', './template/default', 'home/space_pm')
|| checktplrefresh('./template/default/home/space_pm.htm', './template/default/common/seditor.htm', 1348885293, 'diy', './data/template/1_diy_home_space_pm.tpl.php', './template/default', 'home/space_pm')
|| checktplrefresh('./template/default/home/space_pm.htm', './template/default/home/space_prompt_nav.htm', 1348885293, 'diy', './data/template/1_diy_home_space_pm.tpl.php', './template/default', 'home/space_pm')
;?>
<?php $_G['home_tpl_titles'] = array('短消息');?><?php include template('common/header'); ?><div id="pt" class="bm cl"><?php if($_G['setting']['search']) { ?><?php $slist = array();?><?php if($_G['fid'] && $_G['forum']['status'] != 3 && $mod != 'group') { ?><?php
$slist[forumfid] = <<<EOF
...
<?php if($filter != 'newpm') { ?>
<a href="home.php?mod=space&amp;do=pm&amp;filter=newpm" class="xi2">点击这里查看未读的私人消息</a>
<?php } else { ?>
...
<div class="pm_sd">
<ul class="pm_mem_l pm_admin"><?php if(is_array($chatpmmemberlist)) foreach($chatpmmemberlist as $key => $value) { ?><li><a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>" target="_blank" <?php if($ols[$value['uid']]) { ?> class="xi2" title="在线"<?php } else { ?> class="xg1"<?php } ?>><?php echo $value['username'];?></a></li>
<?php } ?>
</ul>
...
<ul>
<li <?php echo $opactives['pm'];?>><a href="home.php?mod=space&amp;do=pm">消息</a></li>
