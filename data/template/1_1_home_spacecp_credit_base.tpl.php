...
0
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/common/header.htm', 1348885983, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/home/spacecp_header.htm', 1348885983, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/home/spacecp_credit_header.htm', 1348885983, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/common/seccheck.htm', 1348885983, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/home/spacecp_footer.htm', 1348885983, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/common/footer.htm', 1348885983, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/common/header_common.htm', 1348885983, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/common/pubsearchform.htm', 1348885983, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/common/simplesearchform.htm', 1348885983, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/home/spacecp_header_name.htm', 1348885983, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/home/spacecp_header_name.htm', 1348885983, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
;?>
...
<?php } ?>
</ul><?php if(in_array($_G['gp_op'], array('base', 'buy', 'transfer', 'exchange'))) { ?>
<ul class="creditl mtm bbda cl"><?php $creditid=0;?><?php if($_G['gp_op'] == 'base' && $_G['setting']['creditstrans']) { ?><?php $creditid=$_G['setting']['creditstrans'];?><?php if($_G['setting']['extcredits'][$creditid]) { ?><?php $credit=$_G['setting']['extcredits'][$creditid];?><li class="xi1 cl"><em><?php if($credit['img']) { ?> <?php echo $credit['img'];?><?php } ?> <?php echo $credit['title'];?>:</em><?php echo getuserprofile('extcredits'.$creditid);; ?> <?php echo $credit['unit'];?> &nbsp; <?php if(($_G['setting']['ec_ratio'] && ($_G['setting']['ec_tenpay_opentrans_chnid'] || $_G['setting']['ec_tenpay_bargainor'] || $_G['setting']['ec_account'])) || $_G['setting']['card']['open']) { ?><a href="home.php?mod=spacecp&amp;ac=credit&amp;op=buy" class="xi2">立即充值&raquo;</a><?php } ?></li>
...
<?php } elseif($_G['gp_op'] == 'buy') { if(($_G['setting']['ec_ratio'] && ($_G['setting']['ec_account'] || $_G['setting']['ec_tenpay_opentrans_chnid'] || $_G['setting']['ec_tenpay_bargainor'])) || $_G['setting']['card']['open']) { ?>
...
<label onclick="$('apitype_tenpay').checked=true;<?php if($_G['setting']['card']['open']) { ?>$('cardbox').style.display='none';if($('card_box_sec')){$('card_box_sec').style.display='none';}$('paybox').style.display='';<?php } ?>"><input name="apitype" type="radio" value="tenpay" id="apitype_tenpay" checked="checked" /><img title="财付通" alt="财付通" onclick="$('apitype_tenpay').checked=true" src="<?php echo STATICURL;?>image/common/tenpay_logo.gif" /></label>
<?php } if($_G['setting']['ec_ratio'] && $_G['setting']['ec_account']) { ?>
<label onclick="$('apitype_alipay').checked=true;<?php if($_G['setting']['card']['open']) { ?>$('cardbox').style.display='none';if($('card_box_sec')){$('card_box_sec').style.display='none';}$('paybox').style.display='';<?php } ?>"><input name="apitype" type="radio" value="alipay" id="apitype_alipay" checked="checked" /><img title="支付宝" alt="支付宝" onclick="$('apitype_alipay').checked=true" src="<?php echo STATICURL;?>image/common/alipay_logo.gif" /></label>
<?php } if($_G['setting']['card']['open']) { ?>
<label onclick="$('apitype_card').checked=true;$('cardbox').style.display='';if($('card_box_sec')){$('card_box_sec').style.display='';}$('paybox').style.display='none';"><input name="apitype" type="radio" value="card" id="apitype_card" checked="checked" /><span class="xs2">充值卡充值</span></label>
<?php } ?>
</td>
</tr>
<tr id="paybox" style="<?php if(($_G['setting']['ec_tenpay_bargainor'] || $_G['setting']['ec_tenpay_opentrans_chnid'] || $_G['setting']['ec_account']) && !$_G['setting']['card']['open'] ) { ?>display:;<?php } else { ?>display:none;<?php } ?>">
<th>充值</th>
<td class="pns">
...
<?php if($_G['setting']['card']['open']) { ?>
<tr id="cardbox" style="<?php if($_G['setting']['card']['open']) { ?>display:;<?php } else { ?>display:none;<?php } ?>">
<th>充值卡</th>
<td colspan="2">
...
$sectpl = <<<EOF
<tr><th><sec></th><td colspan="2"><span id="sec<hash>" onclick="showMenu({'ctrlid':this.id,'win':'{$_G['gp_handlekey']}'})"><sec></span><div id="sec<hash>_menu" class="p_pop p_opt" style="display:none"><sec></div></td></tr>
EOF;
?>
<tbody id="card_box_sec" style="<?php if($_G['setting']['card']['open']) { ?>display:;<?php } else { ?>display:none;<?php } ?>"><?php $_G['sechashi'] = !empty($_G['cookie']['sechashi']) ? $_G['sechash'] + 1 : 0;
...
<?php } } elseif($_G['gp_op'] == 'transfer') { if($_G['setting']['transferstatus'] && $_G['group']['allowtransfer']) { ?>
...
<?php } } elseif($_G['gp_op'] == 'exchange') { if($_G['setting']['exchangestatus'] && ($_G['setting']['extcredits'] || $_CACHE['creditsettings'])) { ?>
