...
0
|| checktplrefresh('./template/default/portal/index.htm', './template/default/common/header.htm', 1348885236, 'diy', './data/template/1_diy_portal_index.tpl.php', './template/default', 'portal/index')
|| checktplrefresh('./template/default/portal/index.htm', './template/default/common/footer.htm', 1348885236, 'diy', './data/template/1_diy_portal_index.tpl.php', './template/default', 'portal/index')
|| checktplrefresh('./template/default/portal/index.htm', './template/default/common/header_common.htm', 1348885236, 'diy', './data/template/1_diy_portal_index.tpl.php', './template/default', 'portal/index')
|| checktplrefresh('./template/default/portal/index.htm', './template/default/common/pubsearchform.htm', 1348885236, 'diy', './data/template/1_diy_portal_index.tpl.php', './template/default', 'portal/index')
;?>
...
<script src="misc.php?mod=diyhelp&action=get&type=index&diy=<?php echo $_G['gp_diy'];?>&r=<?php echo random(4); ?>" type="text/javascript" type="text/javascript"></script>	</div>
