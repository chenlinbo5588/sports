...
0
|| checktplrefresh('./template/default/forum/discuz.htm', './template/default/common/header.htm', 1348885194, 'diy', './data/template/1_diy_forum_discuz.tpl.php', './template/default', 'forum/discuz')
|| checktplrefresh('./template/default/forum/discuz.htm', './template/default/common/footer.htm', 1348885194, 'diy', './data/template/1_diy_forum_discuz.tpl.php', './template/default', 'forum/discuz')
|| checktplrefresh('./template/default/forum/discuz.htm', './template/default/common/header_common.htm', 1348885194, 'diy', './data/template/1_diy_forum_discuz.tpl.php', './template/default', 'forum/discuz')
|| checktplrefresh('./template/default/forum/discuz.htm', './template/default/common/pubsearchform.htm', 1348885194, 'diy', './data/template/1_diy_forum_discuz.tpl.php', './template/default', 'forum/discuz')
;?>
...
<p class="chart z">今日: <em><?php echo $todayposts;?></em><span class="pipe">|</span>昨日: <em><?php echo $postdata['0'];?></em><span class="pipe">|</span>帖子: <em><?php echo $posts;?></em><span class="pipe">|</span>会员: <em><?php echo $_G['cache']['userstats']['totalmembers'];?></em><?php if($_G['setting']['lastmember']) { ?><span class="pipe">|</span>欢迎新会员: <em><a href="home.php?mod=space&amp;username=<?php echo rawurlencode($_G['setting']['lastmember']); ?>" target="_blank" class="xi2"><?php echo $_G['setting']['lastmember'];?></a></em><?php } ?></p>
<div class="y">
<?php if($_G['uid']) { ?><a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>&amp;do=thread&amp;view=me" title="我的帖子" class="xi2">我的帖子</a><?php } if(!empty($_G['setting']['search']['forum']['status'])) { if($_G['uid']) { ?><span class="pipe">|</span><?php } ?><a href="search.php?mod=forum&amp;srchfrom=<?php echo $newthreads;?>&amp;searchsubmit=yes" title="查看新帖" class="xi2">查看新帖</a><?php } ?>
</div>
</div>
<?php } ?>
...
<div class="fl bm"><?php if(is_array($catlist)) foreach($catlist as $key => $cat) { ?><div class="bm bmw <?php if($cat['forumcolumns']) { ?> flg<?php } ?> cl">
<div class="bm_h cl">
<span class="o">
...
<?php if(empty($forum['redirect'])) { ?><dd><em>主题: <?php echo $forum['threads'];?></em>, <em>帖数: <?php echo $forum['posts'];?></em></dd><?php } ?>
<dd>
...
<td class="fl_i">
<?php if(empty($forum['redirect'])) { ?><span class="xi2"><?php echo $forum['threads'];?></span><span class="xg1"> / <?php echo $forum['posts'];?></span><?php } ?>
</td>
<td class="fl_by">
<div>
<?php if($forum['permission'] == 1) { ?>
