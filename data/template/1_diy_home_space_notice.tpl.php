...
0
|| checktplrefresh('./template/default/home/space_notice.htm', './template/default/common/simplesearchform.htm', 1348885285, 'diy', './data/template/1_diy_home_space_notice.tpl.php', './template/default', 'home/space_notice')
|| checktplrefresh('./template/default/home/space_notice.htm', './template/default/home/space_prompt_nav.htm', 1348885285, 'diy', './data/template/1_diy_home_space_notice.tpl.php', './template/default', 'home/space_notice')
;?>
<?php $_G['home_tpl_titles'] = array('提醒');?><?php include template('common/header'); ?><div id="pt" class="bm cl"><?php if($_G['setting']['search']) { ?><?php $slist = array();?><?php if($_G['fid'] && $_G['forum']['status'] != 3 && $mod != 'group') { ?><?php
$slist[forumfid] = <<<EOF
...
<li<?php echo $actives['userapp'];?>><a href="home.php?mod=space&amp;do=notice&amp;view=userapp">应用消息</a></li>
<?php } else { ?>
